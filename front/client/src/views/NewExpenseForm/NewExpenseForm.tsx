...
export default function NewExpenseForm() {
	...
	useEffect(() => {
		fetch('http://localhost:4557/api/modifyInfo/42500393-9805-4bca-8b5d-03df0d297927', {
		method: "GET",
		headers: new Headers({
	...
	const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
		...
		const data = {
			...
			"category": array[3],
			"fix": array[2],
			"coloc_uuid" : "42500393-9805-4bca-8b5d-03df0d297927",
	...
	return (
		<>
			<form id="NewExpenseForm" onSubmit={handleSubmit}>
				...
				<p>Utilisateur connecté (et donc qui paye) : {(currentUser as any).pseudo}</p>
